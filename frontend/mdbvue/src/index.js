...
let Dropdown = require('./components/pro/Dropdown').default;
let mdbDropdown = require('./components/pro/Dropdown').default;
...
// PRO
import Avatar, { mdbAvatar } from './components/pro/Avatar';
import Accordion, { mdbAccordion } from './components/pro/Accordion';
import BtnFixed, { mdbBtnFixed } from './components/pro/BtnFixed';
import BtnFixedItem, { mdbBtnFixedItem } from './components/pro/BtnFixedItem';
import Chip, {mdbChip} from './components/pro/Chip';
import ChipInput, {mdbChipInput} from './components/pro/ChipInput';
import CsvDownloader, {mdbCsvDownloader} from './components/pro/CsvDownloader';
Dropdown = require('./components/pro/Dropdown').default;
mdbDropdown = require('./components/pro/Dropdown').default;
import Preloader, { mdbSpinner } from './components/pro/Preloader';
import Tab, { mdbTab } from './components/pro/Tab';
import TabItem, { mdbTabItem } from './components/pro/TabItem';
import TabContent, { mdbTabContent } from './components/pro/TabContent';
import TabPane, { mdbTabPane } from './components/pro/TabPane';
import TableEditable, { mdbTableEditable } from './components/pro/TableEditable';
import SideNav, { mdbSideNav } from './components/pro/SideNav';
import SubMenu, { mdbSubMenu } from './components/pro/SubMenu';
import { mdbSelect } from './components/pro/Select';
import SelectInput, { mdbSelectInput } from './components/pro/SelectInput';
import SelectOptions, { mdbSelectDropdown } from './components/pro/SelectOptions';
import SelectOption, { mdbSelectOption } from './components/pro/SelectOption';
import MdSwitch, { mdbSwitch } from './components/pro/MdSwitch';
import FileInput, { mdbFileInput } from './components/pro/FileInput';
import RangeInput, { mdbRangeInput } from './components/pro/RangeInput';
import DatePicker, { mdbDatePicker } from './components/pro/DatePicker';
import TimePicker, { mdbTimePicker } from './components/pro/TimePicker/TimePicker';
import Lightbox, { mdbLightbox } from './components/pro/Lightbox';
import MiniChart, { mdbSimpleChart } from './components/pro/MiniChart';
import Scrollbar, { mdbScrollbar } from './components/pro/Scrollbar';
import Step, { mdbStep } from './components/pro/Step';
import Stepper, { mdbStepper } from './components/pro/Stepper';
