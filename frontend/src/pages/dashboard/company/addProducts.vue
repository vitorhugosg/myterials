                ...
                <div class="row pt-5">
                    <div class="col-md-12" v-if="loader == false">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="card p-4">
                                    <transition name="fade animated">
                                        <div class="row">
                                            <!-- Fluxo de adicionar novas collections -->
                                            <div class="col-md-12"  v-if="addOptions.addCollection">
                                            ...
                                            <div class="col-md-12" v-if="addOptions.addCategory">
                                            ...
                                            <div class="col-md-12" v-if="addOptions.addProfileProduct">
                                            ...
                                            <div class="col-md-12" v-if="addOptions.addHazardProduct">
                                            ...
                                            <div class="col-md-12" v-if="addOptions.addVolumeType">
                                        ...
                                        <add-grade-product class="mb-2 caixa-auxiliar" v-if="addOptions.addGradeProduct">

                                        </add-grade-product>

                                        <add-material-type class="mb-2 caixa-auxiliar"  v-if="addOptions.addMaterialType">
                                        </add-material-type>

                                        <add-moisture-product class="mb-2 caixa-auxiliar" v-if="addOptions.addMoistureProduct">
                                        </add-moisture-product>

                                        <add-finish-product class="mb-2 caixa-auxiliar" v-if="addOptions.addFinishProduct">
                                        </add-finish-product>
                                    </transition>
                                </div>
                            </div>
...
export default {
    name: 'Addproducts',
    components:{
        mdbContainer, admin,formAddCompany, mdbCard, mdbCardBody,sideBarCompany,mdbView,mdbMask,mdbCardImage,mdbBtn,mdbIcon,mdbInput,mdbSelect,addVolumeType,addProfileProduct,addMaterialType,addMoistureProduct,addHazardProduct,addGradeProduct,addFinishProduct,addCategory,addCollection
    },
    data() {
        return {
            loader: false,
