        ...
        <mdb-col lg="6" md="12">
            ...
            <mdb-card class="mb-4">
                ...
                <div class="card-body">
                    ...
                    <mdb-btn dark-waves flat rounded class="grey lighten-3 float-right font-weight-bold dark-grey-text">View full report</mdb-btn>
...
<script>
import { mdbContainer, mdbRow, mdbCol, mdbCard, mdbView, mdbCardBody, mdbBadge, mdbBtn } from 'mdbvue'
