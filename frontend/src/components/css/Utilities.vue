<template>
  <mdb-container fluid>
    ...
    <div class="list-group z-depth-1">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/bootstrap-borders/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/clearfix/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/close-icon/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/display-property/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/embeds/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/float/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/flexbox/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/image-replacement/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/position/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/screenreaders/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/sizing/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/spacing/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/text/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/vertical-align/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
        ...
        <!-- Item -->
        <a target="_blank" href="https://mdbootstrap.com/vue/utilities/visibility/" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
            <div>
                <div class="d-flex w-100 justify-content-between">
    ...
    <section>
        ...
        <div class="card text-center my-5">
            ...
            <div class="card-body">
                ...
                <a href="https://mdbootstrap.com/vue/utilities/bootstrap-borders/" target="_blank" class="btn btn-primary">Learn more</a>
            </div>
        </div>
        <!--/.Panel-->
