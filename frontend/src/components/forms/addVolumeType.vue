<template>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <p class="h5 text-center mb-4">Volume Type</p>    
                </div>
            </div>
    ...
    methods:{
        ...
        activeModal(id,type){
            ...
            if(type){
                ...
                this.$http.post(this.$urlAPI + 'products/volume_type/desactive/'+ this.$route.params.idCompany,data,{
                    "headers":{
                        "authorization": "Bearer "+  this.$store.getters.getToken
                    }
                }).then(response =>{
                ...
                let data = {idMaterialType: id};
                this.$http.post(this.$urlAPI + 'products/volume_type/activate/'+ this.$route.params.idCompany,data,{
                    "headers":{
                        "authorization": "Bearer "+  this.$store.getters.getToken
                    }
                }).then(response =>{
