<template>
  <div class="fullscreen white-skin">
    <navbar dark scrolling>
      <mdb-navbar-brand href="#"><strong>Navbar</strong></mdb-navbar-brand>
      <navbar-collapse>
        <navbar-nav>
...
<script>
import { mdbContainer, Row, Column, Navbar, NavbarItem, NavbarNav, NavbarCollapse, ViewWrapper, MdMask, mdbBtn, mdbCard, mdbCardBody, mdbInput, mdbNavbarBrand, mdbTextarea } from 'mdbvue'

export default {
  name: 'About',
  components: {
    mdbContainer, Row, Column, Navbar, NavbarItem, NavbarNav, NavbarCollapse, ViewWrapper, MdMask, mdbBtn, mdbCard, mdbCardBody, mdbInput, mdbNavbarBrand, mdbTextarea
  },
  data () {
    return {
    }
