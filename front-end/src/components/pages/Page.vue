        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4 post-title-panel">
                    <div class="card-body">
                        <mdb-input label="Post title" placeholder="Lorem ipsum dolor sit amet delit" />
                    </div>
                </div>
                <!-- /.First card -->
...
<script>
import { mdbContainer, mdbRow, mdbCol, mdbCard, mdbCardBody, mdbCardText, mdbSelect, mdbBtn, mdbIcon, mdbBadge, mdbView, mdbInput, mdbTextarea } from 'mdbvue'
