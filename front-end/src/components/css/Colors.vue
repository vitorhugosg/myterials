<template>
  <mdb-container fluid>
    ...
    <section id="bootstrap-colors">
      ...
      <!--Title-->
      <h2 class="mt-lg-5 mb-3 font-weight-bold"><strong>Bootstrap colors</strong></h2>

      <!--Description-->
      <p>MDB Admin Dashboard provides you with a sensational palette of 300 delightful, breathing colors.</p>

      <p class="description mb-5">Each color might be exposed in various tones varying from bright to dark. They all are collated in accessible
  ...
  <section id="mdb-colors">
      ...
      <!--Title-->
      <h4 class="mb-5 font-weight-bold font-weight-bold dark-grey-text"><strong>MDB Colors</strong></h4>
  ...
  <section id="dark-theme">
      ...
      <!--Title-->
      <h4 class="mb-5 font-weight-bold dark-grey-text"><strong>Dark Theme</strong></h4>
  ...
  <section id="full-palette">
      ...
      <!--Title-->
      <h4 class="mb-5 font-weight-bold dark-grey-text"><strong>Full Palette</strong></h4>
  ...
  <section id="rgba-colors">
      ...
      <!--Title-->
      <h4 class="mb-5 font-weight-bold dark-grey-text"><strong>RGBA Colors</strong></h4>
      ...
      <section>
          ...
          <div class="row dynamic-color">
              ...
              <div class="col-md-4">
                  ...
                  <div class="rgba-blue-grey-light">
                      <p>rgba(96, 125, 139, 0.3) rgba-blue-grey-light</p>
                  </div>
              ...
              <div class="col-md-4">
                  ...
                  <div class="rgba-blue-grey-strong white-text">
                      <p>rgba(96, 125, 139, 0.7) rgba-blue-grey-strong</p>
                  </div>
              ...
              <div class="col-md-4">
                  ...
                  <div class="rgba-blue-grey-slight">
                      <p>rgba(96, 125, 139, 0.1) rgba-blue-grey-slight</p>
                  </div>
    ...
    <section id="text-colors">
        ...
        <!--Title-->
        <h4 class="mb-5 font-weight-bold dark-grey-text"><strong>Text colors</strong></h4>
    ...
    <section>
        ...
        <div class="card text-center mt-5">
            ...
            <div class="card-body">
                ...
                <a href="https://mdbootstrap.com/colors/" target="_blank" class="btn btn-primary">Learn more</a>
            </div>
        </div>
        <!--/.Panel-->
